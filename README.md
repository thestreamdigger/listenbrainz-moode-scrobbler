...
[![Version](https://img.shields.io/badge/version-1.0.5-blue.svg)](https://github.com/thestreamdigger/listenbrainz-moode-scrobbler)
...
**Learn more:** See [docs/ENV_GUIDE.md](docs/ENV_GUIDE.md) for a complete guide on `.env` files.
